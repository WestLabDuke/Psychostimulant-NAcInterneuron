...
load("../data/PV24PostRepeatedSalVAMPH_input.RData")
...
# writing data
write_csv(data.frame(genes_filt, counts_filt), "../output/PV24HrPostRepeated_RNA/raw_counts_filt.csv")
write_csv(data.frame(genes_filt, rpkm_filt), "../output/PV24HrPostRepeated_RNA/rpkm_counts_filt.csv")
write_csv(data.frame(genes_filt, tpm_filt),  "../output/PV24HrPostRepeated_RNA/tpm_counts_filt.csv")
```
...
write.csv(exp_mat, "../output/PV24HrPostRepeated_RNA/VarianceStabilizedCounts.csv")
head(exp_mat)
```
...
```{r, echo = F}
#-saving plots
png("../output/PV24HrPostRepeated_RNA/Tree_vstCounts.png", height = 7, width = 12, units = 'in', res = 300)
plot(fit)
dev.off()

png("../output/PV24HrPostRepeated_RNA/PCA.png", height = 7, width = 12, units = 'in', res = 300)
pcaPlt
dev.off()
```
...
```{r}
write_csv(exp_mat, "../output/PV24HrPostRepeated_RNA/diffExpressionMatrix.csv")
write_csv(as.data.frame(amphIPvsalIP@listData), "../output/PV24HrPostRepeated_RNA/amphIPvsalIP.csv")
```


Volcano plots
```{r figure S2E, fig.height=9, fig.width=14}
gene_text_size = 7
axis_text_size = 22
title_size = 28
...
png( "../output/PV24HrPostRepeated_RNA/volcano.png",height = 10, width = 20, units = 'in', res = 300)
volcano_p
dev.off()

png( "../output/PV24HrPostRepeated_RNA//MA.png", height = 10, width = 20, units = 'in', res = 300, bg = "transparent")
ma_p
dev.off()
```
...
save.image("../output/PV24HrPostRepeated_RNA/PV24HrPostRepeated_RNA_output.RData")
```
